...
/// and consider general textual substitution.
[<AutoOpen>]
module EquationalLogic =
    ...
    let (|Distrib|_|) =
        ...
        // not (p = q) == not p = q
        | Not(Equiv(a1, a2)), Equiv(Not(a3), a4) when sequal2 a1 a2 a3 a4 -> Some true
        | Equiv(Not(Equiv(a1, a2)), Equiv(Not(a3), a4)), Bool true when sequal2 a1 a2 a3 a4 -> Some true
        | _ -> None
