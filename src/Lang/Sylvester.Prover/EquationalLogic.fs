...
/// Formalizes the equational propsitional logic used by Sylph called S.
...
module EquationalLogic =
    ...
    let logical_axioms =
        ...
        | Distrib x
        | Identity x 
        | ConjLogicalAxioms x-> true
        | _ -> false

    (* Inference rules based on the logical axioms of S*) 
