...
type FsStmt = FsStmt of (string * obj list)
...
module FsStmt = 
    ...
    let stmtProcessor (processor:FsStmt -> unit) (str: string) (parameters: obj list) : unit =
        ...
        FsStmt(stmt, parameters) |> processor

    let createStmtProcessor (processor:FsStmt -> unit) = stmtProcessor processor
