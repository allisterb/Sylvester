module Sylvester.Provider.TensorsTests
...
type Generative2 = Sylvester.Provider.Tensors.GenerativeProvider<2>
type Generative4 = Sylvester.Provider.Tensors.GenerativeProvider<4>
