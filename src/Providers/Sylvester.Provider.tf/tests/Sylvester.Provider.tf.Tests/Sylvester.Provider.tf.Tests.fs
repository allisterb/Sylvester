module Sylvester.Provider.tfTests
...
type Generative2 = Sylvester.Provider.tf.GenerativeProvider<2>
type Generative4 = Sylvester.Provider.tf.GenerativeProvider<4>
