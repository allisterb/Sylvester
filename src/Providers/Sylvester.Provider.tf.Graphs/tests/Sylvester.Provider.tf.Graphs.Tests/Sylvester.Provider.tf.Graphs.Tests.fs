module Sylvester.Provider.tf.GraphsTests
...
type Generative2 = Sylvester.Provider.tf.Graphs.GenerativeProvider<2>
type Generative4 = Sylvester.Provider.tf.Graphs.GenerativeProvider<4>
