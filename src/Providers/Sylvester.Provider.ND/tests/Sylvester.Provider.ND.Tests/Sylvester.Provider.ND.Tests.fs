module Sylvester.Provider.NDTests
...
type Generative2 = Sylvester.Provider.ND.GenerativeProvider<2>
type Generative4 = Sylvester.Provider.ND.GenerativeProvider<4>
