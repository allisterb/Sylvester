...
module NDTensor =
    ...
    /// 3-D Tensor
    type Tensor<'dim0, 'dim1, 'dim2, 't when 'dim0 :> Number and 'dim1 :> Number and 'dim2 :> Number and 't:> ValueType and 't : struct  and 't: (new: unit -> 't) and 't :> IEquatable<'t> and 't :> IFormattable and 't :> IComparable>(graph:ITensorGraph,  head:Node, output:int) =
        inherit Tensor<three, 't>(graph, head, output, [|number<'dim0>.Val; number<'dim1>.Val; number<'dim2>.Val|])
        interface ITensor3
    ...
    /// 4-D Tensor
    type Tensor<'dim0, 'dim1, 'dim2, 'dim3, 't when 'dim0 :> Number and 'dim1 :> Number and 'dim2 :> Number and 'dim3 :> Number and 't:> ValueType and 't : struct  and 't: (new: unit -> 't) and 't :> IEquatable<'t> and 't :> IFormattable and 't :> IComparable>(graph:ITensorGraph,  head:Node, output:int) =
        inherit Tensor<four, 't>(graph, head, output, [|number<'dim0>.Val; number<'dim1>.Val; number<'dim2>.Val; number<'dim3>.Val|])
        interface ITensor4
        member x.Dim0 = number<'dim0>
        member x.Dim1 = number<'dim1>
        member x.Dim2 = number<'dim2>
    ...
    /// 5-D Tensor
    type Tensor<'dim0, 'dim1, 'dim2, 'dim3, 'dim4, 't when 'dim0 :> Number and 'dim1 :> Number and 'dim2 :> Number and 'dim3 :> Number and 'dim4 :> Number and 't:> ValueType and 't : struct  and 't: (new: unit -> 't) and 't :> IEquatable<'t> and 't :> IFormattable and 't :> IComparable>(graph:ITensorGraph,  head:Node, output:int) =
        inherit Tensor<five, 't>(graph, head, output, [|number<'dim0>.Val; number<'dim1>.Val; number<'dim2>.Val; number<'dim3>.Val; number<'dim4>.Val|])
        interface ITensor5
        member x.Dim0 = number<'dim0>
        member x.Dim1 = number<'dim1>
        member x.Dim2 = number<'dim2>
    ...
    /// 6-D Tensor
    type Tensor<'dim0, 'dim1, 'dim2, 'dim3, 'dim4, 'dim5, 't when 'dim0 :> Number and 'dim1 :> Number and 'dim2 :> Number and 'dim3 :> Number and 'dim4 :> Number and 'dim5 :> Number and 't:> ValueType and 't : struct  and 't: (new: unit -> 't) and 't :> IEquatable<'t> and 't :> IFormattable and 't :> IComparable>(graph:ITensorGraph,  head:Node, output:int) =
        inherit Tensor<six, 't>(graph, head, output, [|number<'dim0>.Val; number<'dim1>.Val; number<'dim2>.Val; number<'dim3>.Val; number<'dim4>.Val; number<'dim5>.Val|])
        interface ITensor6
        member x.Dim0 = number<'dim0>
        member x.Dim1 = number<'dim1>
        member x.Dim2 = number<'dim2>
    ...
    type Tensor<'dim0, 'dim1, 'dim2, 'dim3, 'dim4, 'dim5, 'dim6, 't when 'dim0 :> Number and 'dim1 :> Number and 'dim2 :> Number and 'dim3 :> Number and 'dim4 :> Number and 'dim5 :> Number and 'dim6 :> Number and 't:> ValueType and 't : struct  and 't: (new: unit -> 't) and 't :> IEquatable<'t> and 't :> IFormattable and 't :> IComparable>(graph:ITensorGraph,  head:Node, output:int) =
        inherit Tensor<seven, 't>(graph, head, output, [|number<'dim0>.Val; number<'dim1>.Val; number<'dim2>.Val; number<'dim3>.Val; number<'dim4>.Val; number<'dim5>.Val; number<'dim6>.Val|])
        interface ITensor7
        member x.Dim0 = number<'dim0>
        member x.Dim1 = number<'dim1>
        member x.Dim2 = number<'dim2>
    ...
    type Tensor<'dim0, 'dim1, 'dim2, 'dim3, 'dim4, 'dim5, 'dim6, 'dim7, 't when 'dim0 :> Number and 'dim1 :> Number and 'dim2 :> Number and 'dim3 :> Number and 'dim4 :> Number and 'dim5 :> Number and 'dim6 :> Number and 'dim7 :> Number and 't:> ValueType and 't : struct  and 't: (new: unit -> 't) and 't :> IEquatable<'t> and 't :> IFormattable and 't :> IComparable>(graph:ITensorGraph,  head:Node, output:int) =
        inherit Tensor<eight, 't>(graph, head, output, [|number<'dim0>.Val; number<'dim1>.Val; number<'dim2>.Val; number<'dim3>.Val; number<'dim4>.Val; number<'dim5>.Val; number<'dim6>.Val; number<'dim7>.Val|])
        interface ITensor8
        member x.Dim0 = number<'dim0>
        member x.Dim1 = number<'dim1>
        member x.Dim2 = number<'dim2>
    ...
    type Tensor<'dim0, 'dim1, 'dim2, 'dim3, 'dim4, 'dim5, 'dim6, 'dim7, 'dim8, 't when 'dim0 :> Number and 'dim1 :> Number and 'dim2 :> Number and 'dim3 :> Number and 'dim4 :> Number and 'dim5 :> Number and 'dim6 :> Number and 'dim7 :> Number and 'dim8 :> Number and 't:> ValueType and 't : struct  and 't: (new: unit -> 't) and 't :> IEquatable<'t> and 't :> IFormattable and 't :> IComparable>(graph:ITensorGraph,  head:Node, output:int) =
        inherit Tensor<nine, 't>(graph, head, output, [|number<'dim0>.Val; number<'dim1>.Val; number<'dim2>.Val; number<'dim3>.Val; number<'dim4>.Val; number<'dim5>.Val; number<'dim6>.Val; number<'dim7>.Val; number<'dim8>.Val|])
        interface ITensor9
        member x.Dim0 = number<'dim0>
        member x.Dim1 = number<'dim1>
        member x.Dim2 = number<'dim2>
