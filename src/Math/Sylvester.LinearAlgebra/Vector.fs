...
type Vector<'t when 't:> ValueType and 't : struct and 't: (new: unit -> 't) and 't :> IEquatable<'t> and 't :> IFormattable and 't :> IComparable>
    ...
    member val Display = sprintf "Vector<%i> %A" (data.Length) data     
...
type Vector<'dim0, 't when 'dim0 :> Number and 't:> ValueType and 't : struct and 't: (new: unit -> 't) and 't :> IEquatable<'t> and 't :> IFormattable and 't :> IComparable>
    ...
    static member (+)(l : Vector<'n, 't>, r : Vector<'n, 't> when 'n :> Number) : Vector<'n, 't> = Vector<'n, 't>.fromMNVector(Vector<'n, 't>.Ops.VecAdd l._Vector r._Vector)
    static member (-)(l : Vector<'n, 't>, r : Vector<'n, 't> when 'n :> Number) : Vector<'n, 't> = Vector<'n, 't>.fromMNVector(Vector<'n, 't>.Ops.VecSubtract l._Vector r._Vector)
