...
type IVectorSpace<'n, 't when 'n :> Number and 't: equality and 't:> ValueType and 't : struct and 't: (new: unit -> 't) and 't :> IEquatable<'t> and 't :> IFormattable and 't :> IComparable> =  
    inherit IField<'t>
    abstract Dim0:'n
    abstract member Op:BinaryOp<IAbstractVector<'n, 't>>
    abstract member Op2:BinaryOp<IAbstractVector<'n, 't>>
and IAbstractVector<'n, 't when 'n :> Number and 't: equality and 't:> ValueType and 't : struct and 't: (new: unit -> 't) and 't :> IEquatable<'t> and 't :> IFormattable and 't :> IComparable> =
    abstract Dim0:'n
    abstract Item:int->'t
...
type VectorSpace<'n, 't when 'n :> Number and 't: equality and 't:> ValueType and 't : struct and 't: (new: unit -> 't) and 't :> IEquatable<'t> and 't :> IFormattable and 't :> IComparable>
    (field: IField<'t>, op:BinaryOp<IAbstractVector<'n, 't>>, op2:BinaryOp<IAbstractVector<'n, 't>>) =
