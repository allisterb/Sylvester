module Sylvester.Provider.NDArrayTests
...
type Generative2 = Sylvester.Provider.NDArray.GenerativeProvider<2>
type Generative4 = Sylvester.Provider.NDArray.GenerativeProvider<4>
